...
/**
 * See also [NeuronDrawScopeDrawingExtensions.kt] for the drawing functions used here.
 */
            ...
            for (i in 0 until neuralNet.rows) {
                for (j in 0 until neuralNet.cols) {
                    ...
                    when (neuron) {
                        ...
                        is MotorNeuron -> {
                            drawMotorNeuron(cellWidth, cellHeight, centerX, centerY, j, i, neuron)
                        }

                        is SensoryNeuron -> {
                            drawSensoryNeuron(cellWidth, cellHeight, centerX, centerY, j, i, neuron)
                        }
